...
public class Matrix2D : IEquatable<Matrix2D> {
  ...
  public class MatFile {
    ...
    public Dictionary<string, MatFileMaterial> GetMaterialsByName() {
        Dictionary<string, MatFileMaterial> materialsByName = new Dictionary<string, MatFileMaterial>();
