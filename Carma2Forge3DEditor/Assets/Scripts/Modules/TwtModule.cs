...
using UnityEngine;
  ...
  public class TwtModule {
    public TwtFile LoadTwt(string absolutePath) {
      // Taken from https://github.com/MaxxWyndham/Trixx/blob/master/TRixx/Program.cs
      BinaryReader twtReader = new BinaryReader(File.Open(absolutePath, FileMode.Open));
